 ...
 * @author DanielaGF
 */
public class Justificante1 extends javax.swing.JFrame
{
        ...
        FileOutputStream archivo;
            ...
            try {
                ...
                try {
                    ...
                    Logger.getLogger(Justificante1.class.getName()).log(Level.SEVERE, null, ex);
                }

                documento.close();
                JOptionPane.showMessageDialog(null, "PDF creado correctamente","Justificante",1);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(Justificante1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
