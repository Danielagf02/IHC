 ...
 * @author DanielaGF
 */
public class MisHorariosPr extends javax.swing.JFrame
{

    /**
     * Creates new form TodosHorarios
     */
    public MisHorariosPr()
    {
        initComponents();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(MisHorariosPr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new MisHorariosPr().setVisible(true);
            }
        });
    }
