 ...
 * @author DanielaGF
 */
public class BuscarAlumno3 extends javax.swing.JFrame
  {
    ...
    public static void main(String args[])
      {
        ...
        try
          ...
          {
            java.util.logging.Logger.getLogger(BuscarAlumno3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
